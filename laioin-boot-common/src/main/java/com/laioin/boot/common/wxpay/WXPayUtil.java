...
import com.laioin.boot.common.utils.Tools;
...
public class WXPayUtil {
     ...
     * @return
     */
    public static Map<String, String> returnWxPayParameter(Map<String, String> xmlMap) {
        if (null != xmlMap) {
            Map<String, String> returnParameter = new HashMap<String, String>();
            ...
            returnParameter.put("noncestr", Tools.getRandomStringByLength(32));
            returnParameter.put("timestamp", System.currentTimeMillis() / 1000 + "");
